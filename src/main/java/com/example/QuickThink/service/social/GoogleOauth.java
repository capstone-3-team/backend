...
public class GoogleOauth implements SocialOauth {
    ...
    private final String GOOGLE_SNS_CLIENT_ID = "872574453216-352hfpfbnkjnf2sljjf4sukev58nkjfp.apps.googleusercontent.com";
    private final String GOOGLE_SNS_CALLBACK_URL = "http://localhost:8080/auth/google/callback";
    private final String GOOGLE_SNS_CLIENT_SECRET = "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";
